...
public class BottomNavigationItemView extends FrameLayout implements ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(C0078R.layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C0078R.C0079drawable.design_bottom_navigation_item_background);
        this.defaultMargin = res.getDimensionPixelSize(C0078R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C0078R.C0080id.icon);
        this.smallLabel = (TextView) findViewById(C0078R.C0080id.smallLabel);
        this.largeLabel = (TextView) findViewById(C0078R.C0080id.largeLabel);
