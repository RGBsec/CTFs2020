...
class TooltipPopup {
    ...
    TooltipPopup(Context context) {
        ...
        View inflate = LayoutInflater.from(context).inflate(C0003R.layout.abc_tooltip, null);
        this.mContentView = inflate;
        this.mMessageView = (TextView) inflate.findViewById(C0003R.C0005id.message);
        ...
        this.mLayoutParams.windowAnimations = C0003R.style.Animation_AppCompat_Tooltip;
    ...
    private void computePosition(View anchorView, int anchorX, int anchorY, boolean fromTouch, LayoutParams outParams) {
        ...
        int tooltipPreciseAnchorThreshold = this.mContext.getResources().getDimensionPixelOffset(C0003R.dimen.tooltip_precise_anchor_threshold);
        ...
        if (anchorView.getHeight() >= tooltipPreciseAnchorThreshold) {
            int offsetExtra2 = this.mContext.getResources().getDimensionPixelOffset(C0003R.dimen.tooltip_precise_anchor_extra_offset);
        ...
        int tooltipOffset = this.mContext.getResources().getDimensionPixelOffset(fromTouch ? C0003R.dimen.tooltip_y_offset_touch : C0003R.dimen.tooltip_y_offset_non_touch);
