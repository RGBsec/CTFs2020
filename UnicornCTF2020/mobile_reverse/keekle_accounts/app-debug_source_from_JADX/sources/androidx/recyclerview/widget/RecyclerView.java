...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public static abstract class LayoutManager {
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0055R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0055R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0055R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0055R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0055R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    public RecyclerView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attributeSet != null) {
            TypedArray a2 = context2.obtainStyledAttributes(attributeSet, C0055R.styleable.RecyclerView, i, 0);
            String layoutManagerName = a2.getString(C0055R.styleable.RecyclerView_layoutManager);
            int descendantFocusability = a2.getInt(C0055R.styleable.RecyclerView_android_descendantFocusability, -1);
            if (descendantFocusability == -1) {
                setDescendantFocusability(262144);
            }
            boolean z = a2.getBoolean(C0055R.styleable.RecyclerView_fastScrollEnabled, false);
            this.mEnableFastScroller = z;
            if (z) {
                initFastScroller((StateListDrawable) a2.getDrawable(C0055R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), a2.getDrawable(C0055R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) a2.getDrawable(C0055R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), a2.getDrawable(C0055R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
            a2.recycle();
    ...
    public void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        ...
        new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable, resources.getDimensionPixelSize(C0055R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0055R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0055R.dimen.fastscroll_margin));
    }
