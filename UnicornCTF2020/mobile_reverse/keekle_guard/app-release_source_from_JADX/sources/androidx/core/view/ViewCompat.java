...
public class ViewCompat {
    ...
    static class UnhandledKeyEventManager {
        ...
        static UnhandledKeyEventManager m4at(View view) {
            UnhandledKeyEventManager unhandledKeyEventManager = (UnhandledKeyEventManager) view.getTag(C0113R.C0115id.tag_unhandled_key_event_manager);
            if (unhandledKeyEventManager != null) {
                return unhandledKeyEventManager;
            }
            UnhandledKeyEventManager unhandledKeyEventManager2 = new UnhandledKeyEventManager();
            view.setTag(C0113R.C0115id.tag_unhandled_key_event_manager, unhandledKeyEventManager2);
        ...
        private boolean onUnhandledKeyEvent(View view, KeyEvent keyEvent) {
            ArrayList arrayList = (ArrayList) view.getTag(C0113R.C0115id.tag_unhandled_key_listeners);
            if (arrayList != null) {
    ...
    private static List<AccessibilityActionCompat> getActionList(View view) {
        ArrayList arrayList = (ArrayList) view.getTag(C0113R.C0115id.tag_accessibility_actions);
        if (arrayList != null) {
            return arrayList;
        }
        ArrayList arrayList2 = new ArrayList();
        view.setTag(C0113R.C0115id.tag_accessibility_actions, arrayList2);
        return arrayList2;
    }
    ...
    public static void addOnUnhandledKeyEventListener(View view, final OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
        if (VERSION.SDK_INT >= 28) {
            Map map = (Map) view.getTag(C0113R.C0115id.tag_unhandled_key_listeners);
            if (map == null) {
                map = new ArrayMap();
                view.setTag(C0113R.C0115id.tag_unhandled_key_listeners, map);
            }
            C01512 r1 = new OnUnhandledKeyEventListener() {
        ...
        if (arrayList == null) {
            ...
            view.setTag(C0113R.C0115id.tag_unhandled_key_listeners, arrayList);
        }
