...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            int itemViewType = getItemViewType(i);
            if (itemViewType == 0) {
                if (view == null || view.getId() != C0008R.C0010id.list_item) {
                    view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0008R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
                }
                PackageManager packageManager = ActivityChooserView.this.getContext().getPackageManager();
                ResolveInfo resolveInfo = (ResolveInfo) getItem(i);
                ((ImageView) view.findViewById(C0008R.C0010id.icon)).setImageDrawable(resolveInfo.loadIcon(packageManager));
                ((TextView) view.findViewById(C0008R.C0010id.title)).setText(resolveInfo.loadLabel(packageManager));
                ...
                if (view == null || view.getId() != 1) {
                    view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0008R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
                    view.setId(1);
                    ((TextView) view.findViewById(C0008R.C0010id.title)).setText(ActivityChooserView.this.getContext().getString(C0008R.string.abc_activity_chooser_view_see_all));
                }
                return view;
            } else {
                throw new IllegalArgumentException();
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0008R.styleable.ActivityChooserView, i, 0);
        if (VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C0008R.styleable.ActivityChooserView, attributeSet, obtainStyledAttributes, i, 0);
        }
        this.mInitialActivityCount = obtainStyledAttributes.getInt(C0008R.styleable.ActivityChooserView_initialActivityCount, 4);
        Drawable drawable = obtainStyledAttributes.getDrawable(C0008R.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
        obtainStyledAttributes.recycle();
        LayoutInflater.from(getContext()).inflate(C0008R.layout.abc_activity_chooser_view, this, true);
        this.mCallbacks = new Callbacks();
        View findViewById = findViewById(C0008R.C0010id.activity_chooser_view_content);
        this.mActivityChooserContent = findViewById;
        this.mActivityChooserContentBackground = findViewById.getBackground();
        FrameLayout frameLayout = (FrameLayout) findViewById(C0008R.C0010id.default_activity_button);
        ...
        FrameLayout frameLayout2 = (FrameLayout) findViewById(C0008R.C0010id.expand_activities_button);
        ...
        ImageView imageView = (ImageView) frameLayout2.findViewById(C0008R.C0010id.image);
    ...
    public void showPopupUnchecked(int i) {
        if (this.mAdapter.getDataModel() != null) {
            ...
            if (!listPopupWindow.isShowing()) {
                ...
                listPopupWindow.getListView().setContentDescription(getContext().getString(C0008R.string.abc_activitychooserview_choose_application));
