...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
        ...
        public void show(int i, int i2) {
            ...
            if (!isShowing) {
                ...
                if (viewTreeObserver != null) {
                    final C00692 r6 = new OnGlobalLayoutListener() {
    ...
    public AppCompatSpinner(Context context, int i) {
        this(context, null, C0008R.attr.spinnerStyle, i);
    }

    public AppCompatSpinner(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0008R.attr.spinnerStyle);
    }
    ...
    public AppCompatSpinner(android.content.Context r7, android.util.AttributeSet r8, int r9, int r10, android.content.res.Resources.Theme r11) {
        /*
            ...
            goto L_0x0034
        L_0x0022:
            int r11 = androidx.appcompat.C0008R.styleable.Spinner_popupTheme
        ...
        L_0x006c:
            ...
            r10.<init>(r3, r8, r9)
            android.content.Context r3 = r6.mPopupContext
            int[] r4 = androidx.appcompat.C0008R.styleable.Spinner
            ...
            int r3 = androidx.appcompat.C0008R.styleable.Spinner_android_dropDownWidth
            r4 = -2
            int r3 = r1.getLayoutDimension(r3, r4)
            r6.mDropDownWidth = r3
            int r3 = androidx.appcompat.C0008R.styleable.Spinner_android_popupBackground
        ...
        L_0x00a3:
            ...
            r10.<init>()
            r6.mPopup = r10
            int r1 = androidx.appcompat.C0008R.styleable.Spinner_android_prompt
            java.lang.String r1 = r0.getString(r1)
            r10.setPromptText(r1)
        L_0x00b3:
            int r10 = androidx.appcompat.C0008R.styleable.Spinner_android_entries
            java.lang.CharSequence[] r10 = r0.getTextArray(r10)
            if (r10 == 0) goto L_0x00cb
            android.widget.ArrayAdapter r1 = new android.widget.ArrayAdapter
            r3 = 17367048(0x1090008, float:2.5162948E-38)
            r1.<init>(r7, r3, r10)
            int r7 = androidx.appcompat.C0008R.layout.support_simple_spinner_dropdown_item
