...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0008R.styleable.ActionBar);
        this.mBackground = obtainStyledAttributes.getDrawable(C0008R.styleable.ActionBar_background);
        this.mStackedBackground = obtainStyledAttributes.getDrawable(C0008R.styleable.ActionBar_backgroundStacked);
        this.mHeight = obtainStyledAttributes.getDimensionPixelSize(C0008R.styleable.ActionBar_height, -1);
        boolean z = true;
        if (getId() == C0008R.C0010id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = obtainStyledAttributes.getDrawable(C0008R.styleable.ActionBar_backgroundSplit);
        }
