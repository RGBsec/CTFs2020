...
public final class zzc extends Fragment implements LifecycleFragment {
    ...
    public static zzc zza(FragmentActivity fragmentActivity) {
        ...
        try {
            zzc zzc2 = (zzc) fragmentActivity.getSupportFragmentManager().findFragmentByTag(str);
            if (zzc2 == null || zzc2.isRemoving()) {
                zzc2 = new zzc();
                fragmentActivity.getSupportFragmentManager().beginTransaction().add((Fragment) zzc2, str).commitAllowingStateLoss();
            }
