    ...
    public static class AlertParams {
        ...
        private void createListView(final AlertController dialog) {
            ...
            if (!this.mIsMultiChoice) {
                ...
                C01071 r1 = new ArrayAdapter<CharSequence>(this.mContext, dialog.mMultiChoiceItemLayout, 16908308, this.mItems) {
                ...
                C01082 r12 = new CursorAdapter(this.mContext, this.mCursor, false) {
