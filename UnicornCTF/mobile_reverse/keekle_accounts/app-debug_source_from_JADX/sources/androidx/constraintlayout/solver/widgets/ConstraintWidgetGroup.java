        ...
        if (widget.mOptimizerMeasurable && !widget.isFullyResolved()) {
            ...
            if (targetAnchor != null) {
                ...
                if (targetAnchor.mType == Type.RIGHT) {
                    end3 = targetAnchor.mOwner.f22mX + targetAnchor.mOwner.getWidth();
                } else if (targetAnchor.mType == Type.LEFT) {
                    end3 = targetAnchor.mOwner.f22mX;
                }
            }
            if (rightSide) {
            ...
            if (widget.mBaseline.mTarget != null) {
                ...
                int start = (targetAnchor3.mOwner.f23mY + targetAnchor3.mOwner.mBaselineDistance) - widget.mBaselineDistance;
            ...
            if (targetAnchor2 != null) {
                ...
                if (targetAnchor2.mType == Type.BOTTOM) {
                    end = targetAnchor2.mOwner.f23mY + targetAnchor2.mOwner.getHeight();
                } else if (targetAnchor2.mType == Type.TOP) {
                    end = targetAnchor2.mOwner.f23mY;
                }
            }
            if (bottomSide) {
