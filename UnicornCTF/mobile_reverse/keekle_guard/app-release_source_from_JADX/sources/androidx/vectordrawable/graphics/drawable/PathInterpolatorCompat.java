...
public class PathInterpolatorCompat implements Interpolator {
    ...
    private void initPath(Path path) {
        ...
        if (min > 0) {
            this.f31mX = new float[min];
            this.f32mY = new float[min];
            ...
            if (((double) Math.abs(this.f31mX[0])) <= 1.0E-5d && ((double) Math.abs(this.f32mY[0])) <= 1.0E-5d) {
                int i3 = min - 1;
                if (((double) Math.abs(this.f31mX[i3] - 1.0f)) <= 1.0E-5d && ((double) Math.abs(this.f32mY[i3] - 1.0f)) <= 1.0E-5d) {
                    float f = 0.0f;
                    int i4 = 0;
                    while (i < min) {
                        float[] fArr2 = this.f31mX;
                        int i5 = i4 + 1;
                        float f2 = fArr2[i4];
                        if (f2 >= f) {
                            fArr2[i] = f2;
            ...
            sb2.append(this.f31mX[0]);
            String str = ",";
            sb2.append(str);
            sb2.append(this.f32mY[0]);
            sb2.append(" end:");
            int i6 = min - 1;
            sb2.append(this.f31mX[i6]);
            sb2.append(str);
            sb2.append(this.f32mY[i6]);
