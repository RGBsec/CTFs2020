...
server_secret = "Aero{fakeflagfakeflagfakeflagfakeflag}"
KEY = 'flkeflagfakeflag'.encode()
...
def get_server_secret(msg):
    ...
    ret = base64.b64encode(aes.encrypt(pad(msg).encode()))
    print(AES.new(KEY, AES.MODE_ECB).decrypt(base64.b64decode(ret)).decode())
